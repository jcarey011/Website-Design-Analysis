...
@rem ##########################################################################
@rem
@rem  Website-Design-Analysis startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and WEBSITE_DESIGN_ANALYSIS_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEBSITE_DESIGN_ANALYSIS_OPTS%  -classpath "%CLASSPATH%"  %*
...
:fail
rem Set variable WEBSITE_DESIGN_ANALYSIS_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%WEBSITE_DESIGN_ANALYSIS_EXIT_CONSOLE%" exit 1
exit /b 1
